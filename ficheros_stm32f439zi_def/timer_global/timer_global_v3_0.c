...
static void Timer_EnableIRQ(TIM_TypeDef *instance){
    if      (instance == TIM1)  {  HAL_NVIC_EnableIRQ(TIM1_UP_TIM10_IRQn);      }
    else if (instance == TIM2)  {  HAL_NVIC_EnableIRQ(TIM2_IRQn);               }
    else if (instance == TIM3)  {  HAL_NVIC_EnableIRQ(TIM3_IRQn);               }
    else if (instance == TIM4)  {  HAL_NVIC_EnableIRQ(TIM4_IRQn);               }
    else if (instance == TIM5)  {  HAL_NVIC_EnableIRQ(TIM5_IRQn);               }
    else if (instance == TIM6)  {  HAL_NVIC_EnableIRQ(TIM6_DAC_IRQn);           }
    else if (instance == TIM7)  {  HAL_NVIC_EnableIRQ(TIM7_IRQn);               }
    else if (instance == TIM8)  {  HAL_NVIC_EnableIRQ(TIM8_UP_TIM13_IRQn);      }
    else if (instance == TIM9)  {  HAL_NVIC_EnableIRQ(TIM1_BRK_TIM9_IRQn);      }
    else if (instance == TIM10) {  HAL_NVIC_EnableIRQ(TIM1_UP_TIM10_IRQn);      }
    else if (instance == TIM11) {  HAL_NVIC_EnableIRQ(TIM1_TRG_COM_TIM11_IRQn); }
    else if (instance == TIM12) {  HAL_NVIC_EnableIRQ(TIM8_BRK_TIM12_IRQn);     }
    else if (instance == TIM13) {  HAL_NVIC_EnableIRQ(TIM8_UP_TIM13_IRQn);      }
    else if (instance == TIM14) {  HAL_NVIC_EnableIRQ(TIM8_TRG_COM_TIM14_IRQn); }
}
